...
/**
 * https://github.com/Fevol/obsidian-typings/blob/main/obsidian-ex.d.ts
 */
...
type PropertyWidgetType = 'aliases' | 'checkbox' | 'date' | 'datetime' | 'multitext' | 'number' | 'tags' | 'text';
...
declare module 'obsidian' {
  ...
  interface FileManager {
     ...
     * @internal
     */
    fileParentCreatorByType: Map<string, (e: any) => any>;
    /**
     * @internal
     */
     ...
     * @internal
     */
    linkUpdaters: Map<string, (e: any) => any>;
    /**
     * @internal
     */
    updateQueue: Map<string, (e: any) => any>;
    /**
     * Reference to Vault
     */
    vault: Vault;
  ...
  interface Workspace {
     ...
     */
    iterateTabs: (tabs: WorkspaceSplit | WorkspaceSplit[], cb: (leaf: any) => boolean) => boolean;
    /**
  ...
  interface Vault {
     ...
     */
    exists: (file: TAbstractFile, sensitive?: boolean) => Promise<boolean>;
    /**
     * @internal
     */
    generateFiles: (e: any) => Promise<void>;
    /**
