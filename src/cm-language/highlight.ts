import { EditorState, Extension, Facet, Prec, RangeSetBuilder } from '@codemirror/state';
import { Decoration, DecorationSet, EditorView, ViewPlugin, ViewUpdate } from '@codemirror/view';
import { NodeType, Tree } from '@lezer/common';
import { Highlighter, Tag, highlightTree, tagHighlighter, tags } from '@lezer/highlight';
import { StyleModule, StyleSpec } from 'style-mod';
import { Language, languageDataProp, syntaxTree } from './language';
