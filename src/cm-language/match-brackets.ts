import { EditorState, Extension, Facet, Range, StateField, combineConfig } from '@codemirror/state';
import { Decoration, DecorationSet, EditorView } from '@codemirror/view';
import { NodeProp, NodeType, SyntaxNode, SyntaxNodeRef, Tree } from '@lezer/common';
