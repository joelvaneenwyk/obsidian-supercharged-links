          ...
          syntaxTree(view.state).iterate({
            ...
            enter: (node: SyntaxNodeRef) => {
              ...
              if (tokenProps) {
                ...
                if (!isPipe && !isAlias) {
                  if (iconDecoAfterWhere && iconDecoAfter) {
                ...
                if ((isLink && !isAlias && !isPipe) || isMDUrl) {
                  ...
                  let file = mdView?.file?.basename
                    ? app.metadataCache.getFirstLinkpathDest(linkText, mdView.file.basename)
                    : null;
                  if (isMDUrl && !file) {
                    try {
                  ...
                  if (file) {
                    const _attributes = fetchTargetAttributesSync(app, plugin, settings, file, true);
                    ...
                    if (mdAliasFrom && mdAliasTo && isMDUrl) {
